...
<?php  
  if ( $levelLogin !== "super admin" ) {
    echo "
      <script>
        alert('Anda tidak diberi akses untuk melihat hallaman ini !!');
        self.close();
      </script>
    ";
  }  
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                          ...
                          <input type="text" name="" class="form-control" value="<?= tanggal_indo($kasbon['kasbon_date']); ?>" readonly="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                          ...
                          <?php  
                            $kasbon_user_id_kasbon = $kasbon['kasbon_user_id_kasbon'];
                          ...
                          ?>
                          <input type="text" name="" class="form-control" value="<?= $namaUser; ?>" readonly="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                          ...
                          <input type="text" name="" class="form-control" value="<?= $kasbon['kasbon_nama']; ?>" readonly="">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                          <label for="">Keterangan Lengkap Kasbon</label>
                          <textarea name="kasbon_desc" id="kasbon_desc" class="form-control" readonly="required" placeholder="Keperluan Kasbon Secara Detail" style="height:123px;" ><?= $kasbon['kasbon_desc']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                      <div class="form-group">
                          ...
                          <?php  
                            $kasbon_user_create = $kasbon['kasbon_user_create'];
                            $namaUser = mysqli_query($conn, "SELECT user_nama FROM user WHERE user_id = $kasbon_user_create ");
                            $namaUser = mysqli_fetch_array($namaUser);
                            $namaUser = $namaUser['user_nama'];
                          ?>
                          <input type="text" name="" class="form-control" value="<?= $namaUser; ?>" readonly="">
