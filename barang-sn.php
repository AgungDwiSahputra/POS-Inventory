...
<?php  
  ...
  $barangId   = base64_encode($kodeCountId);
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="tambah-data">
            <?php if ( $stockSN > 0 ) { ?>
          	<a href="barang-sn-add?no=<?= $urlStockSN; ?>&id=<?= $urlID; ?>&cabang=<?= $cabang; ?>&barangid=<?= $barangId; ?>" class="btn btn-primary">Tambah Data No. SN</a>
            <?php } ?>
