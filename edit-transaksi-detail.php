              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    $total = 0;
	                  $i = 1; 
	                  $queryProduct = $conn->query("SELECT penjualan.penjualan_id, penjualan.keranjang_harga, barang.barang_id, barang.barang_nama, barang.barang_harga, barang.barang_stock, penjualan.barang_qty_lama_parent, penjualan.penjualan_invoice
	                             FROM penjualan 
                      ...
                      $subTotal = $rowProduct['barang_qty_lama_parent'] * $rowProduct['keranjang_harga'];
                      $total += $subTotal;
	                ?>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    $total = 0;
                    $i = 1; 
                    $queryProduct = $conn->query("SELECT penjualan.penjualan_id, penjualan.keranjang_harga, barang.barang_id, barang.barang_nama, barang.barang_harga, barang.barang_stock, penjualan.barang_qty, penjualan.penjualan_invoice
                               FROM penjualan 
                               JOIN barang ON penjualan.barang_id = barang.barang_id
                               WHERE penjualan_invoice = $invoice1
                               ORDER BY penjualan_id DESC
