<?php 
  ...
  $keranjang = query("SELECT * FROM keranjang_non_fisik WHERE knf_id = $id")[0];
?>


	<input type="hidden" name="knf_id" value="<?= $id; ?>">
  <div class="form-group ">
	 ...
	 <div class="form-group">
        ...
        <input type="number" name="knf_harga_beli" class="form-control" id="knf_harga_beli" value="<?= $keranjang['knf_harga_beli']; ?>" required>
    </div>

    <div class="form-group">
        <label for="knf_harga_jual">Harga Jual</label>
        <input type="number" name="knf_harga_jual" class="form-control" id="knf_harga_jual" value="<?= $keranjang['knf_harga_jual']; ?>" required>
    </div>


    <div class="form-group">
        <label for="knf_qty">Edit QTY</label>
        <input type="number" min="1" name="knf_qty" class="form-control" value="<?= $keranjang['knf_qty'] ?>" required> 
    </div>

    <div class="form-group">
        <label for="knf_qty">Catatan</label>
        <textarea name="knf_catatan" id="knf_catatan" class="form-control" rows="5" placeholder="Input Catatan Transkasi Produk"><?= $keranjang['knf_catatan']; ?></textarea>
    </div>
