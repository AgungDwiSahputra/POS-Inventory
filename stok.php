              ...
              <div class="table-auto">
                <table id="laporan-stok-terkecil" class="table table-bordered table-striped table-laporan">
                  ...
                  <?php 
                    ...
                    $totalBeli = 0;
                    $totalJual = 0;
                    $queryProduct = $conn->query("SELECT barang.barang_id, barang.barang_kode, barang.barang_nama, barang.barang_harga_beli, barang.barang_harga, barang.barang_stock, barang.barang_cabang, kategori.kategori_id, kategori.kategori_nama, satuan.satuan_id, satuan.satuan_nama
                               FROM barang 
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <td>
                          <?php if ( $rowProduct['barang_harga_beli'] > 0 ) : ?>
                            <?php $totalHargaBeli = $rowProduct['barang_harga_beli'] * $rowProduct['barang_stock']; ?>
              ...
              <div class="table-auto">
                <table id="laporan-stok-terkecil" class="table table-bordered table-striped table-laporan">
                  ...
                  <?php 
                    ...
                    $totalBeli = 0;
                    $totalJual = 0;
                    $queryProduct = $conn->query("SELECT barang.barang_id, barang.barang_kode, barang.barang_nama, barang.barang_harga_beli, barang.barang_harga, barang.barang_stock, barang.barang_kategori_id, barang.barang_cabang, kategori.kategori_id, kategori.kategori_nama, satuan.satuan_id, satuan.satuan_nama
                               FROM barang 
                               JOIN kategori ON barang.kategori_id = kategori.kategori_id
                               JOIN satuan ON barang.satuan_id = satuan.satuan_id
