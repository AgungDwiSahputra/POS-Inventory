...
<?php  
  ...
  if ( $invoice['invoice_tipe_non_fisik'] > 0 ) {
    echo '
      <script>
        alert("Fitur Retur Hanya digunakan untuk transaksi Item !!");
        document.location.href="penjualan";
      </script>
    ';
  }
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; width: 11%;">
                        <form role="form" action="" method="post">
                          ...
                          <input type="hidden" name="barang_qty_lama" value="<?= $rowProduct['barang_qty']; ?>">
                        ...
                        <table class="table">
                          ...
                          <tr>
                             ...
                             <td class="table-nominal">
                                ...
                                <span>
                                  <?php  
                                    $invoiceSubTotal = ($invoice['invoice_ongkir'] + $total) - $invoice['invoice_diskon'];
                                  ?>
