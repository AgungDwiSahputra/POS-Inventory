          ...
          <div class="modal-body" id="data-edit-pembelian">
            <div class="row">
                <div class="col-md-7 col-lg-7">
                    <a href="penjualan-delete-invoice-tanpa-mengembalikan-saldo?id=<?= base64_decode($_GET['id']); ?>&page=<?= base64_decode($_GET['link']); ?>" class="btn btn-danger">Tanpa Mengembalikan Saldo</a>
                </div>
                <div class="col-md-5 col-lg-5">
                  <?php  
                    $id = abs((int)base64_decode($_GET['id']));
                    $tipe = mysqli_query($conn, "SELECT invoice_tipe_tarik_tunai FROM invoice WHERE invoice_id = $id ");
                    $tipe = mysqli_fetch_array($tipe);
                    $invoice_tipe_tarik_tunai = $tipe['invoice_tipe_tarik_tunai'];
                  ?>
                    <a href="penjualan-delete-invoice-mengembalikan-saldo?id=<?= base64_decode($_GET['id']); ?>&page=<?= base64_decode($_GET['link']); ?>&tipe=<?= $invoice_tipe_tarik_tunai; ?>" class="btn btn-info">Mengembalikan Saldo</a>
                </div>
            </div>
          </div>
