              ...
              <form role="form" action="" method="post">
                <div class="card-body">
                  <div class="row">
                    ...
                    <?php if ( $invoiceBayar < $invoiceSubTotal ) { ?>
                    <?php  
                      $invoice_kembali = $invoice['invoice_kembali'];
                      $maxBayar = str_replace("-", "", $invoice_kembali);
                    ?>
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                          <label for="">Nominal Cicilan</label>
                          <input type="number" name="piutang_nominal" class="form-control" id="piutang_nominal" required="" max="<?= $maxBayar; ?>">
                        </div>
                    </div>
