...
<style>
  ...
  <div class="content-wrapper">
    ...
    <?php  
    	$data = query("SELECT * FROM user WHERE user_cabang = $sessionCabang && user_id > 1 && user_kasbon > 0 && user_kasbon_status > 0  ORDER BY user_id DESC");
    ?>
    <!-- Main content -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td class="orderan-online-button">
                      ...
                      <a href="kasbon-user-delete?id=<?= base64_encode($idUser); ?>&page=<?= base64_encode('kasbon-user'); ?>" onclick="return confirm('Yakin dihapus ?')" title="Delete Data">
