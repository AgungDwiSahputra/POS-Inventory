                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6">
                          ...
                          <div class="form-group">
                            ...
                            <?php else : ?>
                              <input type="number" name="" class="form-control" id="barang_stock" value="<?= $barang['barang_stock']; ?>" readonly>
                              <input type="hidden" name="barang_stock" class="form-control" id="barang_stock" value="<?= base64_encode($barang['barang_stock']); ?>" required>
                            <?php endif; ?>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="barang_harga_beli" class="form-control" id="barang_harga" value="<?= $barang['barang_harga_beli']; ?>" required>
                            </div>
                        </div>
                    </div>
                  </div>
