  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Pembelian Per Periode</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Laporan Periode Pembelian</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="table-auto">
                <table id="laporan-periode-pembelian" class="table table-bordered table-striped table-laporan">
                  <thead>
                  <tr>
                  ...
                  <?php 
                    ...
                    $queryInvoice = $conn->query("SELECT invoice_pembelian.invoice_pembelian_id ,invoice_pembelian.pembelian_invoice, invoice_pembelian.invoice_tgl, supplier.supplier_id, supplier.supplier_nama, supplier.supplier_company, invoice_pembelian.invoice_total, invoice_pembelian.invoice_pembelian_cabang
                               ...
                               WHERE invoice_pembelian_cabang = '".$sessionCabang."' && invoice_hutang < 1 && invoice_date BETWEEN '".$tanggal_awal."' AND '".$tanggal_akhir."'
