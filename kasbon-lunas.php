  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Kasbon Lunas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="bo">Home</a></li>
              <li class="breadcrumb-item active">Kasbon Lunas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    $(document).ready(function(){
        var table = $('#example1').DataTable( { 
             "processing": true,
             "serverSide": true,
             "ajax": "kasbon-data.php?cabang=<?= $sessionCabang; ?>&status=1",
             "columnDefs": 
             [
              {
        ...
        $('#example1 tbody').on( 'click', '.tblDelete', function () {
            ...
            if ( link === true ) {
                window.location.href = "kasbon-delete?id="+ data0 + "&page=lunas";
            }
        });
