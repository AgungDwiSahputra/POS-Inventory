        ...
        <section class="content">
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Laporan Provider Keseluruhan dari Tanggal <b><?= tanggal_indo($tanggal_awal); ?></b> Sampai <b><?= tanggal_indo($tanggal_akhir); ?></b></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <table id="laporan-tarik-tunai" class="table table-bordered table-striped table-laporan">
                      ...
                      <?php 
                        ...
                        $queryPenjualan = $conn->query("SELECT penjualan_barang_non_fisik.pbnf_id, 
                          ...
                          penjualan_barang_non_fisik.pbnf_provider_sisa_saldo, 
                          ...
                          barang_non_fisik.bnf_nama
                                   ...
                                   WHERE pbnf_cabang = '".$sessionCabang."' && pbnf_date BETWEEN '".$tanggal_awal."' AND '".$tanggal_akhir."' 
                      ...
                      <tr>
                          ...
                          <td>
                              <?php $pbnf_harga_beli = $rowProduct['pbnf_harga_beli'] * $rowProduct['pbnf_qty'] ?>
                              Rp. <?= number_format($pbnf_harga_beli, 0, ',', '.'); ?>   
                          </td>
                          <td>
                              <?php $pbnf_harga_jual = $rowProduct['pbnf_harga_jual'] * $rowProduct['pbnf_qty'] ?>
                              Rp. <?= number_format($pbnf_harga_jual, 0, ',', '.'); ?>
                          </td>
                          <td>Rp. <?= number_format($rowProduct['pbnf_provider_sisa_saldo'], 0, ',', '.'); ?></td>
                      </tr>
                      <?php $i++; ?>
                      <?php } ?>
                    </tbody>
        ...
        <section class="content">
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Laporan <b>Provider <?= $provider_nama; ?></b> dari Tanggal <b><?= tanggal_indo($tanggal_awal); ?></b> Sampai <b><?= tanggal_indo($tanggal_akhir); ?></b></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="table-auto">
                      ...
                      <?php 
                        ...
                        $queryPenjualan = $conn->query("SELECT penjualan_barang_non_fisik.pbnf_id, 
                          ...
                          barang_non_fisik.bnf_nama
                                   FROM penjualan_barang_non_fisik 
                                   JOIN barang_non_fisik ON penjualan_barang_non_fisik.pbnf_barang_id = barang_non_fisik.bnf_id
                                   WHERE pbnf_provider = $barang_id && pbnf_cabang = '".$sessionCabang."' && pbnf_date BETWEEN '".$tanggal_awal."' AND '".$tanggal_akhir."' 
                                   ORDER BY pbnf_id DESC
                                   ");
                        while ($rowProduct = mysqli_fetch_array($queryPenjualan)) {
                        $totalModal += $rowProduct['pbnf_harga_beli'];
